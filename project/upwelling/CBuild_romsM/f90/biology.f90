...
!
     ...
     &  "/staff/liyuanhang/work/2024OCT/roms_8/roms/project/upwelling/fennel.h"
!
...
!
      ...
      END IF
!
      CALL wclock_on (ng, iNLM, 15, 169, MyFile)
     ...
     &                  DIAGS(ng) % DiaBio3d,                           &
     &                  OCEAN(ng) % t)
      CALL wclock_off (ng, iNLM, 15, 207, MyFile)
!
      RETURN
...
! two different bacteria types. If  is defined, nitrification is
