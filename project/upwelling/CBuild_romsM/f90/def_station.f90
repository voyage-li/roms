...
!
      character (len=*), parameter :: MyFile =                          &
     &  "ROMS/Utility/def_station.F"//", def_station_nf90"
!
      SourceFile=MyFile
!
!-----------------------------------------------------------------------
...
!
      DEFINE : IF (ldef) THEN
        ...
        IF (FoundError(exit_flag, NoError, 172, MyFile)) THEN
...
!
     ...
     &                   SetFillVal = .TRUE.,                           &
     &                   SetParAccess = .TRUE.)
          IF (FoundError(exit_flag, NoError, 330, MyFile)) RETURN
        END IF
!
...
!
     ...
     &                   SetFillVal = .TRUE.,                           &
     &                   SetParAccess = .TRUE.)
          IF (FoundError(exit_flag, NoError, 375, MyFile)) RETURN
        END IF
!
     ...
     &                   SetFillVal = .TRUE.,                           &
     &                   SetParAccess = .TRUE.)
          IF (FoundError(exit_flag, NoError, 388, MyFile)) RETURN
        END IF
!
...
!
     ...
     &                   SetFillVal = .TRUE.,                           &
     &                   SetParAccess = .TRUE.)
          IF (FoundError(exit_flag, NoError, 435, MyFile)) RETURN
        END IF
!
     ...
     &                   SetFillVal = .TRUE.,                           &
     &                   SetParAccess = .TRUE.)
          IF (FoundError(exit_flag, NoError, 448, MyFile)) RETURN
        END IF
!
...
!
     ...
     &                   SetFillVal = .TRUE.,                           &
     &                   SetParAccess = .TRUE.)
          IF (FoundError(exit_flag, NoError, 478, MyFile)) RETURN
        END IF
!
...
!
     ...
     &                   SetFillVal = .TRUE.,                           &
     &                   SetParAccess = .TRUE.)
          IF (FoundError(exit_flag, NoError, 725, MyFile)) RETURN
        END IF
!
...
!
     ...
     &                   SetFillVal = .TRUE.,                           &
     &                   SetParAccess = .TRUE.)
          IF (FoundError(exit_flag, NoError, 933, MyFile)) RETURN
        END IF
!
!-----------------------------------------------------------------------
...
!
        ...
        IF (FoundError(exit_flag, NoError, 1055, MyFile)) THEN
