...
!                                                                      !
!  This routine is the main driver for ROMS/TOMS nonlinear model (NLM) !
...
!$OMP BARRIER
            END DO
            IF (FoundError(exit_flag, NoError, 255, MyFile)) RETURN
!
!-----------------------------------------------------------------------
...
!$OMP END MASTER
!$OMP BARRIER
              IF ((FoundError(exit_flag, NoError, 582, MyFile)).or.     &
