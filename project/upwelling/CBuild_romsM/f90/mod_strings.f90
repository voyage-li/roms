...
!
        ...
        character (len=80)  :: my_fc = '/staff/liyuanhang/intel/oneapi/mpi/2021.11/bin/mpiifort'
        character (len=512) :: my_fflags = ' -fp-model precise -ip -O3 -traceback -check uninit'
!
        character (len=256) :: Adir = '/staff/liyuanhang/work/2024OCT/roms_8/roms/project/upwelling'
        character (len=256) :: Hdir = '/staff/liyuanhang/work/2024OCT/roms_8/roms/project/upwelling'
        character (len=256) :: Hfile = "upwelling.h"
        character (len=256) :: Rdir = '/staff/liyuanhang/work/2024OCT/roms_8/roms'
!
